        ...
        docRef.get()
            .addOnSuccessListener { document ->
                if (document["balance"] != null)
                {
                    ...
                    db.collection("users").document(FirebaseAuth.getInstance().currentUser?.phoneNumber.toString()).collection("statements").document("TID-SM-"+Random.nextBytes(9)).set(myStatementData)
                        .addOnSuccessListener {
                        }
                        .addOnFailureListener {
                    ...
                    db.collection("users").document(editText_sm_client_number.text.toString()).collection("statements").document("TID-SM-"+Random.nextBytes(9)).set(clientStatementData)
                        .addOnSuccessListener {
                        }
                        .addOnFailureListener {
